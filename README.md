...
Biomedical engineer turned color & imaging nerd by way of **Cairo University** and the **Erasmus Mundus COSI** program (NTNU · UJM · UEF).
And Outside of imaging, I've also shipped work in medical AI, speech systems, and systems-level C++.

```python
osama = {
    "🎓 background": "Biomedical engineering → Computational Color & Spectral Imaging",
    "🔬 interests":  "Medical Imaging, ISP, GPU shaders, Computer Graphics",
    "💻 building":   "things that touch an image, CV pipelines, viewers, real-time graphics",
